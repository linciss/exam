<div class="flex flex-row gap-2 justify-between items-center container mx-auto mt-5 md:px-0 px-8 text-black dark:text-white">
    <form class="flex flex-row gap-1">
        ...
        <button type="submit" class="hover:bg-nav px-2 py-1 border border-gray-500 bg-orange-200 dark:bg-zinc-700 rounded-md">Meklēt</button>
    </form>

    <button id="<?php echo $buttonType ?>" class="hover:bg-nav px-2 py-1 border border-gray-500 bg-orange-200 dark:bg-zinc-700 rounded-md ">
